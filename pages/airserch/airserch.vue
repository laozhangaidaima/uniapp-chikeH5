<template>
	<view>
		...
		<view v-for="(item,index) in airData" :key="index" style="margin-left: 41.66rpx;margin-top: 83.33rpx; " @click="toAirListDetail(index)">
			<u-row gutter="16" style="align-items: start;margin-top: 41.66rpx;">
				...
				<u-col span="3" class="font3" style="display: flex;align-items: center; ">{{"￥" +item.priceFare+"起" }}</u-col>
			</u-row>
			<u-row gutter="16" style="margin-top: 10px;margin-left: 3px; " class="font2">
				<u-image width="12px" height="12px" src="http://img.shanglv51.com/ChaiKe/Aircode/MF.png" style="margin-right: 8.33rpx;"></u-image>
